...
<div id="top">
 <div class="wrap">
  <ul class="topNav">
   ...
   <!-- {if $user} -->
   <li class="spacer"></li>
   <li><a href="{$url.user}">{$user.user_name}，{$lang.user_welcom_top}</a></li>
   <li class="spacer"></li>
  ...
  <ul class="search">
   <div class="searchBox">
    <form name="search" id="search" method="get" action="{$site.root_url}">
     ...
     <input name="s" type="text" class="keyword" title="{$lang.search_product_cue}" autocomplete="off" onclick="formClick(this,'{$lang.search_product}')" value="{if $keyword}{$keyword|escape}{else}{$lang.search_product}{/if}" size="25" maxlength="128">
